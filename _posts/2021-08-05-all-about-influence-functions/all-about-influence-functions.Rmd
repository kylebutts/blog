...
description: |
 Notes on Influence Functions with the math fully worked out
author:
  - name: Kyle Butts
...
Note that this material is mainly a summary of the math in the below three sources compiled together with additional writing by myself.
...
This is helpful because then asymptotics comes easy^[This is similar to OLS asymptotics: $$ \sqrt{n} \hat\beta - \beta_0 = \frac{1}{\sqrt{n}} \sum_{i=1}^n (X'X)^{-1}X'\varepsilon + \sqrt{n} * \text{higher order terms} $$]:
...
## Appendix: Matrix Algebra rules {.appendix}
